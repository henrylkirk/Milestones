...
public class FileConvertGUI {
   ...
   public void createDRScreen() {
      ...
      JComponent panel = makeTextPanel("Preliminary Steps to Run\nThis application is Java-based. Before installing and running the app, please visit www.java.com/en/download/ to install the latest version of Java.\n\nRunning application from Linux/Unix\nA \"README.md\" had been included with the installation of this application. This file outlines the steps to compile all the required Java classes necessary to have the installation run on a Linux OS. Copy and paste the commands provided to compile all classes included in the installation. If you are operating off a Unix OS, double-clicking the JAR file included in the installation should run the application automatically. If the app does not open upon clicking the JAR, please consult online documentation for potential fixes.");
      tabbedHelpPane.addTab("How to run the application", null, panel, "How to run the application.");
      JComponent panel2 = makeTextPanel("It is recommended that the Edge Diagram generated from the corresponding Edge file being read by this application is a Physical ERD. This will help the application define associative tables before datatype and relational edits.");
      tabbedHelpPane.addTab("How to open an Edge file", null, panel2, "How to parse an Edge file");
      JComponent panel3 = makeTextPanel("The Output File Location must always be the directory in which the application installation is running. This applies to both SAV and SQL files generated by this application. To set the output location, please load an Edge or XML file into the application and then go to \"Options > Set Output File Definition Location\". You may create separate directories within the directory running the installation to organize SAV and SQL files.");
      tabbedHelpPane.addTab("Setting the output file location", null, panel3, "How to set the output file location.");
      JComponent panel4 = makeTextPanel("<database>\n\t<table name='STUDENT'>\n\t\t<attribute id='8'>STUDENTNAME</attribute>\n\t\t<attribute id='7'>STUDENTSSN</attribute>\n\t</table>\n\t<table name='FACULTY'>\n\t\t<attribute id='11'>FACULTYNAME</attribute>\n\t\t<attribute id='6'>FACULTYSSN</attribute>\n\t</table>\n\t<table name='COURSES'>\n\t\t<attribute>COURSENUM</attribute>\n\t\t<attribute>COURSENAME</attribute>\n\t</table>\n\t<table name='STUDENT_GRADES'>\n\t\t<attribute>STUDENTSSN</attribute>\n\t\t<attribute>COURSENUM</attribute>\n\t\t<attribute>GRADE</attribute>\n\t</table>\n\t<connector id=\"9\">\n\t\t<figure>1</figure>\n\t\t<figure>7</figure>\n\t\t<end-style>null</end-style>\n\t\t<end-style>null</end-style>\n\t</connector>\n</database>\n\nThe root node should be 'database'. The immediate child node should be 'table', and each table should have a name property. Table nodes should contain 'attribute' nodes with the name of that attribute as the value between the tags. The first line of the XML should be: 'XML File' without the quotes.");
      tabbedHelpPane.addTab("Formatting an XML file", null, panel4, "How to format an XML file");
   ...
   protected JComponent makeTextPanel(String text) {
       ...
       JTextArea ta = new JTextArea(text, 1, 20);
   ...
   class MenuListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
         ...
         if ((ae.getSource() == jmiDTHelpAbout) || (ae.getSource() == jmiDRHelpAbout)) {
            ...
            helpFrame.getContentPane().setSize(1600, 800);
